        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {Object.values(groupedByRestaurant).map((group: any) => (
              <div key={group.restaurant?._id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                {/* Restaurant Header */}
                        ...
                        <div className="flex gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-3 mt-3">
                              <button
                                onClick={() =>
                                  handleUpdateQuantity(food._id, item.quantity - 1)
                                }
                              ...
                              <button
                                onClick={() => handleDeleteCartItem(food._id)}
