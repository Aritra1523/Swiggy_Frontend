...
//   string,
//   { icon: typeof CheckCircle2; color: string; label: string; message: string }
// > = {
//   approved: {
//     icon: CheckCircle2,
...
//   // Pull a larger page for dashboard stats — there's no dedicated stats
//   // endpoint on the backend, so this derives counts from the food list
//   // itself. Fine at small-to-medium menu sizes; would need a real
//   // aggregate endpoint if menus grow into the hundreds of items.
...
//           <div className="animate-pulse bg-white rounded-2xl h-32 shadow-sm" />
...
//     return (
//       <main className="p-6 md:p-10">
//         <div className="max-w-md mx-auto text-center bg-white rounded-2xl border border-dashed border-gray-300 p-10 mt-10">
//           <Store className="w-10 h-10 text-gray-300 mx-auto mb-3" />
//           <p className="text-gray-900 font-semibold">No restaurant profile yet</p>
//           <p className="text-sm text-gray-500 mt-1">
//             Complete onboarding to start setting up your menu.
//           </p>
//         </div>
//       </main>
//     );
...
//             <span
//               className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold border shrink-0 ${status.color}`}
//             >
...
//               {foodsLoading ? "—" : totalItems}
//             </p>
//           </div>
//           <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
//             <p className="text-sm text-gray-500">Available now</p>
//             <p className="text-2xl font-bold text-green-600 mt-1">
//               {foodsLoading ? "—" : availableCount}
//             </p>
//           </div>
//           <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
//             <p className="text-sm text-gray-500">Awaiting approval</p>
//             <p className="text-2xl font-bold text-yellow-600 mt-1">
//               {foodsLoading ? "—" : pendingApprovalCount}
//             </p>
//           </div>
//         </div>
...
//             className="flex-1 inline-flex items-center justify-center gap-2 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors"
//           >
...
//           <Link
//             href="/owner/foods"
//             className="flex-1 inline-flex items-center justify-center gap-2 py-3 border border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-white transition-colors"
//           >
...
//                   className="flex items-center justify-between py-2.5 px-2 rounded-xl hover:bg-gray-50 transition-colors"
//                 >
