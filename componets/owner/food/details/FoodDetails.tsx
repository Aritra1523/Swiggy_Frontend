...
// import { ArrowLeft, Pencil, Utensils, CheckCircle2, Clock, XCircle } from "lucide-react";
...
//           </p>
//           <button
//             onClick={() => router.push("/owner/foods/foddList")}
...
//               <span
//                 className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold border shrink-0 ${approval.color}`}
//               >
...
//             {/* Rejection reason — the one thing the list page never shows */}
...
//             {food.description && (
//               <p className="text-gray-600 text-sm mb-5">{food.description}</p>
//             )}
...
//                 </p>
//                 <p className="text-sm font-medium text-gray-900 mt-0.5">
//                   {food.rating > 0 ? `${food.rating} ★ (${food.totalRatings})` : "No ratings yet"}
//                 </p>
//               </div>
//               <div>
//                 <p className="text-xs text-gray-400 uppercase tracking-wide">
...
//                     food.isAvailable ? "text-green-600" : "text-gray-500"
//                   }`}
//                 >
...
//               className="w-full mt-6 inline-flex items-center justify-center gap-2 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors"
//             >
