...
export default function Navbar() {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      // This is the actual fix for "UI doesn't update until refresh":
      // clearing cookies alone never touched in-memory state. Redux still
      // held the old user, and TanStack Query still cached old cart/food
      // data, so every component kept rendering as if still logged in.
      dispatch(logout());
      queryClient.clear();
