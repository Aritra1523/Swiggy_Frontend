    ...
    <>
      <nav className="sticky top-0 z-50 h-20 flex items-center justify-between px-6 md:px-10 shadow-md bg-white/95 backdrop-blur-sm border-b border-gray-100">
        ...
        <div className="hidden md:flex items-center gap-2 lg:gap-6">
          ...
          {/* Cart */}
          <button className="relative p-2.5 text-gray-600 hover:text-orange-500 rounded-full hover:bg-orange-50 transition-all duration-200">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
            ...
            {cartCount > 0 && (
              <span className="absolute -top-1 -right-1 min-w-5 h-5 px-1 bg-orange-500 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-md">
