...
//   return (
//     <section className="relative bg-gradient-to-br from-orange-50 to-white py-16 md:py-24">
...
//             <span className="text-orange-500">Hungry?</span> Order food
//           </h1>
//           <p className="text-xl md:text-2xl text-gray-600 mb-8">
//             from your favourite restaurants, delivered to your doorstep
//           </p>
...
//                 className="w-full px-6 py-4 rounded-full border-0 focus:ring-2 focus:ring-orange-500 outline-none text-gray-800 placeholder-gray-400"
//               />
//               <button
//                 type="submit"
//                 className="absolute right-2 bg-orange-500 text-white px-6 py-2 rounded-full hover:bg-orange-600 transition-colors font-medium"
//               >
//                 Search
//               </button>
//             </div>
