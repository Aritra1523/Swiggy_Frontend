...
// Backend stores/returns relative paths like "/uploads/xyz.png" — these
// need the backend's own origin prepended, since a relative src in <img>
// resolves against the current page (this Next.js app on :3000), not the
// Express server actually serving the file (on :4000).
